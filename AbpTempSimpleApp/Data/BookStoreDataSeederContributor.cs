    ...
    public async Task SeedAsync(DataSeedContext context)
    {
        if (await _bookRepository.GetCountAsync() <= 0)
        {
            await _bookRepository.InsertAsync(
                ...
                {
                    Name = "1984",
                    Description = "A dystopian novel about surveillance, censorship, and authoritarian control.",
            ...
            await _bookRepository.InsertAsync(
                new Book
                {
                    ...
                    Description = "A comic science fiction adventure across space with Arthur Dent and Ford Prefect.",
