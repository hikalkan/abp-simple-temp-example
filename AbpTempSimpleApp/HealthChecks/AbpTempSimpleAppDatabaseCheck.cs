...
public class AbpTempSimpleAppDatabaseCheck : IHealthCheck, ITransientDependency
{
    protected readonly IIdentityRoleRepository IdentityRoleRepository;

    public AbpTempSimpleAppDatabaseCheck(IIdentityRoleRepository identityRoleRepository)
    {
